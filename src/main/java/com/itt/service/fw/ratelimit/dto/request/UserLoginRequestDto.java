...
public class UserLoginRequestDto {
	...
	@Schema(requiredMode = RequiredMode.REQUIRED, example = "be.chinmaya@gmail.com", description = "email-id associated with user account already created in the system")
